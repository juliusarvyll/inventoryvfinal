...
use App\Policies\PreventiveMaintenanceItemPolicy;
use App\Policies\PreventiveMaintenancePolicy;
use App\Policies\PreventiveMaintenanceSessionPolicy;
...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(PreventiveMaintenanceItem::class, PreventiveMaintenanceItemPolicy::class);
        Gate::policy(PreventiveMaintenanceSession::class, PreventiveMaintenanceSessionPolicy::class);
